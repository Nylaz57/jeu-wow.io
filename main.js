...
function generationIcone() {
    fetch('DATA/icone.php')
        ...
        .then(data => {
            ...
            randomID = randomIcon.Id_technique;
            ...
            liste.push(randomID);
            iconName = randomIcon.nom_technique;
            iconeImg = randomIcon.icone_image;
            classeImg = randomIcon.image_classe;
            classe = randomIcon.nom_classe;
            race = randomIcon.nom_race;
            faction = randomIcon.nom_faction;
            factionImg = randomIcon.image_faction
            raceImg = randomIcon.image_race
            // Si la liste est pleine d'ID unique on reset le tout
                if (liste.length === data.length) {
                liste = [];
                }
            if ((randomID == 115 || randomID == 172)){
            document.querySelector('h1').innerHTML = `Quel est le nom de cette technique en&nbsp;<span class=${classe}><img src=${classeImg}>&nbsp;${classe}</span>&nbsp;<span class=${faction}><img src=${raceImg}>&nbsp;${race} </span>&nbsp?`;
            document.querySelector('.icons').innerHTML = `<img src=${iconeImg}>`; 
            } 
            else if (randomID == 371){
            document.querySelector('h1').innerHTML = `Quel est le nom de cette technique en&nbsp;<span class=${classe}><img src=${classeImg}>&nbsp;${classe}</span>&nbsp;<span class=${faction}><img src=${raceImg}>&nbsp;${race}</span>&nbsp?`;
            document.querySelector('.icons').innerHTML = `<img src=${iconeImg}>`;
            }
            ...
            document.querySelector('h1').innerHTML = `Quel est le nom de cette technique en&nbsp;<span class=${classe}><img src=${classeImg}>&nbsp;${classe}</span>&nbsp;<span class=${faction}><img src=${raceImg}>&nbsp;${race}</span>&nbsp;et&nbsp;<span class=${faction}><img src=${raceImg}>&nbsp;${race} </span>&nbsp?`;
            document.querySelector('.icons').innerHTML = `<img src=${iconeImg}>`;
            }
            else if ((randomID == 275) || (randomID == 352)){
            document.querySelector('h1').innerHTML = `Quel est le nom de cette technique en&nbsp;<span class=${classe}><img src=${classeImg}>&nbsp;${classe}</span>&nbsp;<span class=${faction}><img src=${raceImg}>&nbsp;${race}</span>&nbsp?`;
            document.querySelector('.icons').innerHTML = `<img src=${iconeImg}>`;
            }
            else if ((randomID == 329) || (randomID == 341)){
            document.querySelector('h1').innerHTML = `Quel est le nom de cette technique en&nbsp;<span class=${classe}><img src=${classeImg}>&nbsp;${classe}</span>&nbsp;<span class=${faction}><img src=${raceImg}>&nbsp;${race} </span>&nbsp?`;
            document.querySelector('.icons').innerHTML = `<img src=${iconeImg}>`;
            }
            else if ((randomID == 122) || (randomID == 121) || (randomID == 119)|| (randomID == 113)|| (randomID == 112)|| (randomID == 110) || (randomID == 108) || (randomID == 109) || (randomID == 111)|| (randomID == 116)|| (randomID == 117)|| (randomID == 120)){
            document.querySelector('h1').innerHTML = `Quel est le nom de cette technique en&nbsp;<span class=${classe}><img src=${classeImg}>&nbsp;${classe}</span>&nbsp;<span class=${faction}><img src=${factionImg}>&nbsp;${faction} </span>&nbsp?`;
            document.querySelector('.icons').innerHTML = `<img src=${iconeImg}>`;
            }
            else {
            document.querySelector('h1').innerHTML = `Quel est le nom de cette technique en&nbsp;<span class=${classe}><img src=${classeImg}>&nbsp;${classe}</span>&nbsp;?`;
            document.querySelector('.icons').innerHTML = `<img src=${iconeImg}>`;
            }
        });
}
...
function Differences() {
    ...
    // Pour chaque iconName
    let iconNameArray = [];
    iconNameArray.push(iconName)
    iconNameArray.forEach(name => {
